...
class Capybara::Selector
  ...
  def call(locator, selector_config: nil, **options); end
  ...
  def initialize(name, locator_type: nil, raw_locator: nil, &block); end
...
class Capybara::Selector::Filters::LocatorFilter < Capybara::Selector::Filters::NodeFilter
  ...
  def matches?(node, value, context = nil); end
end
...
class Capybara::Queries::SelectorQuery < Capybara::Queries::BaseQuery
  ...
  def first_try?; end
  def initialize(*args, session_options:, enable_aria_label: nil, test_id: nil, **options, &filter_block); end
  def label; end
  def locator; end
  def match; end
  ...
  def matches_visible_filter?(node); end
  def name; end
  def negative_failure_message; end
  def node_filters; end
...
class Capybara::Selenium::Driver < Capybara::Driver::Base
  ...
  def specialize_driver(sel_driver); end
  def switch_to_frame(frame); end
  def switch_to_window(handle); end
  def title; end
