...
class Regexp::Scanner
  ...
  def empty_backref_error(type, what); end
  def empty_name_error(type, what); end
  def free_spacing; end
  def free_spacing=(arg0); end
  def group_depth; end
  def group_depth=(arg0); end
  def in_group; end
  def in_group=(arg0); end
  def literal; end
  def literal=(arg0); end
  def scan(input_object, &block); end
  def scan_options(p, data, ts, te); end
...
class Regexp::Expression::Sequence < Regexp::Expression::Subexpression
  ...
  def quantify(token, text, min = nil, max = nil, mode = nil); end
  def self.add_to(subexpression, options = nil); end
...
class Regexp::Expression::Backreference::NumberCallRelative < Regexp::Expression::Backreference::Number
end
class Regexp::Expression::Backreference::NameCall < Regexp::Expression::Backreference::Name
end
class Regexp::Expression::Backreference::NumberRecursionLevel < Regexp::Expression::Backreference::Base
  def initialize(token, options = nil); end
  def number; end
  def recursion_level; end
end
class Regexp::Expression::Backreference::NameRecursionLevel < Regexp::Expression::Backreference::Base
  def initialize(token, options = nil); end
  def name; end
  def recursion_level; end
end
