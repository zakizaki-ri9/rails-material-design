...
class MaterialIcon
  ...
  include ::ActionView::Helpers::CaptureHelper
  include ::ActionView::Helpers::OutputSafetyHelper
  def css_class(css_class=T.unsafe(nil)); end

  def flip_horizontal(); end

  def flip_vertical(); end

  def html(html=T.unsafe(nil)); end
  ...
  def send(name=T.unsafe(nil), *args); end

  def style(css_style=T.unsafe(nil)); end

  def super_send(*_); end
...
module MaterialIcons
  MATERIAL_ICONS_VERSION = ::T.let(nil, ::T.untyped)
  VERSION = ::T.let(nil, ::T.untyped)
end

module MaterialIcons::MaterialIconHelper
  def material_icon(); end
...
class Solargraph::Source::Chain::Call
  ...
  def initialize(word, arguments=T.unsafe(nil)); end
end
...
class Solargraph::Source::NodeChainer
  ...
  def initialize(node, filename=T.unsafe(nil)); end
end

class Solargraph::Source::NodeChainer
  def self.chain(node, filename=T.unsafe(nil)); end
...
class Solargraph::YardMap::Mapper
  def self.object_location(obj, spec=T.unsafe(nil)); end
end
